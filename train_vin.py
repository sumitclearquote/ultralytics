...
project_name = "vin" # the dir where datasets' folder is present and where results in yolo_runs will be stored.
project_dir = "vin" # # Name of project inside 'datadrive'
server_name = "paintfrmladmin01" # username of the remote machine

#name of the dataset folder
dataset_name = "vin_engraved_yolo_v1" #wheelrim and lifting pads were expanded by 5% of bbox area
