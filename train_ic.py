...
train_versions =  ["trial_p_n", "trial_s", "trial_p_s"]   #["v1_p_n", "v1_s", "v1_p_s"]         #["v1_n", "v1_p_n", "v1_s", "v1_p_s"]  #-original
imgsizes = [224, 320, 480, 640]    #-original

for train_version in train_versions:
    for imgsize in imgsizes:
        
        if f"{train_version}_{imgsize}" in ["trial_p_n_224", "trial_p_n_320"]:continue
